...
function NewHeader() {
  ...
  return (
    <Wrapper scrolled={isScrolled}>
      ...
      <RouterList>
        <NewHeaderContent>Cart</NewHeaderContent>
        <NewHeaderContent>Liked</NewHeaderContent>
      </RouterList>
    </Wrapper>
  );
}
...
const NewHeaderBox = styled.div<{ scrolled: boolean }>`
  position: sticky;
  top: 0;
  left: 0;
  padding: 10px 140px;
...
const NewHeaderContent = styled.li`
  list-style: none;
  font-family: "Prata-Regular";
  font-size: 1vw;
  font-weight: 700;
