      ...
      <table className="shopping_list_table">
        <tbody>
          <tr>
            <td>기본 배송지</td>
            <td>
              {userData ? userData.deliveryInfo.defaultDeliveryAddress : "없음"}
            </td>
          </tr>
          <tr>
            <td>배송지 1</td>
            <td>
              {userData ? userData.deliveryInfo.firstDeliveryAddress : "없음"}
            </td>
          </tr>
          <tr>
            <td>배송지 2</td>
            <td>
              {userData ? userData.deliveryInfo.secondDeliveryAddress : "없음"}
            </td>
          </tr>
        </tbody>
      </table>
