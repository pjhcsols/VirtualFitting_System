...
import { ProductOrderListProps } from "../types/product";
  ...
  return (
    <div className="order_list_container">
      <div className="header_div">
        <h2 className="order_list_title" onClick={handleOrderListPage}>
          주문 내역 조회
        </h2>
      </div>
      {isEmpty ? (
        ...
        <table className="order_list_table">
          ...
          <tbody
            style={
              isOrderListPage ? { borderBottom: "2px solid black" } : undefined
            }
          >
