      ...
      <div className='main'>
        ...
        <div className='mainBrand'>
          <div className='content'>
            ...
            <span>
              The brand BASILIUM, which means "decorations of kings and queens," was expressed<br />
              under the motto of silver ornaments worn by ancient kings. I promise to grow further as a<br />
              brand that pursues standard and simple details without losing a fresh feeling with a new<br />
